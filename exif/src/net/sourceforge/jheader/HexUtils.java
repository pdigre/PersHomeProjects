...
/**
 * <p>Converting to and from hex values.</p>
 */
public class HexUtils
{
	...
	for (int i=0; i<chars.length; i+=2)
	{
		...
		default: throw new NumberFormatException("Not a hex number");
		}
		b <<= 4*(1-k);
	    } // for (int k...
	    if (b >= 128) bytes[j] = (byte)(128-b);
	    else bytes[j] = (byte)b;
	} // for (int i...
	return bytes;
    }
	...
	for (int i=0; i<bytes.length; ++i)
	{
	    ...
	    {
		int byte_i = bytes[i];
		if (byte_i < 0) byte_i = 128-byte_i;
		int hb = (byte_i >> ((1-k)*4)) % 16;
		switch (hb)
		{
		case 0: chars[j+k] = '0'; break;
		case 1: chars[j+k] = '1'; break;
		case 2: chars[j+k] = '2'; break;
		case 3: chars[j+k] = '3'; break;
		case 4: chars[j+k] = '4'; break;
		case 5: chars[j+k] = '5'; break;
		case 6: chars[j+k] = '6'; break;
		case 7: chars[j+k] = '7'; break;
		case 8: chars[j+k] = '8'; break;
		case 9: chars[j+k] = '9'; break;
		case 10: chars[j+k] = 'A'; break;
		case 11: chars[j+k] = 'B'; break;
		case 12: chars[j+k] = 'C'; break;
		case 13: chars[j+k] = 'D'; break;
		case 14: chars[j+k] = 'E'; break;
		case 15: chars[j+k] = 'F'; break;
