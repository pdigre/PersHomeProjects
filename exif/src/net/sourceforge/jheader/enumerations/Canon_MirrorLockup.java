...
public class Canon_MirrorLockup extends EnumeratedTag
{
    ...
    static
    {
	populate(Canon_MirrorLockup.class, data);
    }

    
    public Canon_MirrorLockup(Long value) {super(value);}
    public Canon_MirrorLockup(String value) throws TagFormatException {super(value);}
}
