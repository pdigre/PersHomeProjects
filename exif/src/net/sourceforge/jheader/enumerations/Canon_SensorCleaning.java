...
public class Canon_SensorCleaning extends EnumeratedTag
{
    ...
    static
    {
	populate(Canon_SensorCleaning.class, data);
    }

    
    public Canon_SensorCleaning(Long value) {super(value);}
    public Canon_SensorCleaning(String value) throws TagFormatException {super(value);}
}
