...
public class ExposureProgram extends EnumeratedTag
{
    ...
    static
    {
	populate(ExposureProgram.class, data);
    }

    
    public ExposureProgram(Long value) {super(value);}
    public ExposureProgram(String value) throws TagFormatException {super(value);}
}
