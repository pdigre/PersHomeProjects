...
public class GameData {
    ...
    public Move makeMove(int i) {
        int[] filterFrom = NodeGen.filterFrom(eval.getBitmaps(), from);
        int bitmap = NodeGen.filterTo(filterFrom, i)[0];
        Move startGame = new Move(lastmove, bitmap);
        return startGame;
    }
