...
public class App1Header
{
	...
	INTEROP("InterOp"),
	IFD1("IFD1"),
	MAKERNOTE_OLYMPUS("Olympus"),
	MAKERNOTE_NIKON("Nikon"),
	MAKERNOTE_NIKOND1("Nikon D1"),
	MAKERNOTE_CASIO("Casio"),
	MAKERNOTE_CASIO2("Casio 2"),
	MAKERNOTE_FUJIFILM("FujiFilm"),
	MAKERNOTE_CANON("Canon");
	
	public String label;

    ExifLocation(String label){
	    this.label=label;
	}
