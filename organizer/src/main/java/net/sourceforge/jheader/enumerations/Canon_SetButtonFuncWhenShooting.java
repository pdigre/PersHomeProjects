...
public class Canon_SetButtonFuncWhenShooting extends EnumeratedTag
{
	...
	CHANGE_ISO_SPEED, "Change ISO Speed",
    ...
    public Canon_SetButtonFuncWhenShooting(Long value) {super(value);}
    public Canon_SetButtonFuncWhenShooting(String value) throws TagFormatException {super(value);}
}
