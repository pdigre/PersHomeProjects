...
public class Fujifilm_FocusMode extends EnumeratedTag
{
    ...
    static
    {
	populate(Fujifilm_FocusMode.class, data);
    }

    
    public Fujifilm_FocusMode(Long value) {super(value);}
    public Fujifilm_FocusMode(String value) throws TagFormatException {super(value);}
}
