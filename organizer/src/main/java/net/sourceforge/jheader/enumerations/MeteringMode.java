...
public class MeteringMode extends EnumeratedTag
{
	...
	UNKNOWN, "Unknown",
	AVERAGE, "Average",
	CENTER_WEIGHTED_AVERAGE, "Centre-weighted average",
	SPOT, "Spot",
    ...
    static
    {
	populate(MeteringMode.class, data);
    }

    
    public MeteringMode(Long value) {super(value);}
    public MeteringMode(String value) throws TagFormatException {super(value);}
}
