...
public class Canon_ShutterAeLockButtons extends EnumeratedTag
{
	...
	AF_AE_LOCK, "AF/AE Lock",
	AE_LOCK_AF, "AE Lock/AF",
	AF_AF_LOCK, "AF/AF Lock",
	AE_RELEASE_AE_AF, "AE+Release/AE+AF"
    };

    static
    {
	populate(Canon_ShutterAeLockButtons.class, data);
    }

    
    public Canon_ShutterAeLockButtons(Long value) {super(value);}
    public Canon_ShutterAeLockButtons(String value) throws TagFormatException {super(value);}
}
