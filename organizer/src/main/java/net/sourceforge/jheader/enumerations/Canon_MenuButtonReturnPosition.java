...
public class Canon_MenuButtonReturnPosition extends EnumeratedTag
{
	...
	TOP, "Top",
	PREVIOUS_VOLATILE, "Previous (Volatile)",
	PREVIOUS, "Previous"
    };

    static
    {
	populate(Canon_MenuButtonReturnPosition.class, data);
    }

    
    public Canon_MenuButtonReturnPosition(Long value) {super(value);}
    public Canon_MenuButtonReturnPosition(String value) throws TagFormatException {super(value);}
}
