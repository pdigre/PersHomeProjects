...
{
    public static final long DIGITAL_CAMERA = 0x03;
    ...
    public FileSource(Long value) {super(value);}
    public FileSource(String value) throws TagFormatException {super(value);}
}
