...
public class Canon_ShutterCurtainSync extends EnumeratedTag
{
	...
	FIRST_CURTAIN_SYNC, "1st Curtain Sync",
	SECOND_CURTAIN_SYNC, "2nd Curtain Sync"
    };
    ...
    public Canon_ShutterCurtainSync(Long value) {super(value);}
    public Canon_ShutterCurtainSync(String value) throws TagFormatException {super(value);}
}
