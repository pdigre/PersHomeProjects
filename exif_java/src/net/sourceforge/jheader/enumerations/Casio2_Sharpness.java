...
public class Casio2_Sharpness extends EnumeratedTag
{
    ...
    static
    {
	populate(Casio2_Sharpness.class, data);
    }

    
    public Casio2_Sharpness(Long value) {super(value);}
    public Casio2_Sharpness(String value) throws TagFormatException {super(value);}
}
