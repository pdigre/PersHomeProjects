...
public class GainControl extends EnumeratedTag
{
    ...
    public static final long HIGH_DOWN = 4;
	 ...
	 NONE, "None",
	 LOW_UP, "Low gain up",
	 HIGH_UP, "High gain up",
	 LOW_DOWN, "Low gain down",
	 HIGH_DOWN, "High gain down"
    };

    static
    {
	populate(GainControl.class, data);
    }

    
    public GainControl(Long value) {super(value);}
    public GainControl(String value) throws TagFormatException {super(value);}
}
