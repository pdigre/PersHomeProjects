...
public class Nikon_Quality extends EnumeratedTag
{
	...
	VGA_BASIC, "VGA Basic",
	VGA_NORMAL, "VGA Normal",
	VGA_FINE, "VGA Fine",
	XSGA_BASIC, "XSGA Basic",
	XSGA_NORMAL, "XSGA Normal",
	XSGA_FINE, "XSGA Fine",
    };

    static
    {
	populate(Nikon_Quality.class, data);
    }

    
    public Nikon_Quality(Long value) {super(value);}
    public Nikon_Quality(String value) throws TagFormatException {super(value);}
}
