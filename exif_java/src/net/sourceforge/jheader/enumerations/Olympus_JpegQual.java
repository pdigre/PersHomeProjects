...
public class Olympus_JpegQual extends EnumeratedTag
{
    ...
    static
    {
	populate(Olympus_JpegQual.class, data);
    }

    
    public Olympus_JpegQual(Long value) {super(value);}
    public Olympus_JpegQual(String value) throws TagFormatException {super(value);}
}
